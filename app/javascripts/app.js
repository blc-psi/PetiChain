...
window.createPetition = function createPetition() {
  var titel = document.getElementById("crpe-titel");
  var desc = document.getElementById("crpe-description");
  var startTime = document.getElementById("crpe-starttime");
  var endTime = document.getElementById("crpe-endtime");
  var votesPerP = 0;
...
function deployPetition(_tokenAddress) {
  ...
  var _id = id_count;
  id_count += 1;
  var _description = document.getElementById("crpe-description");
